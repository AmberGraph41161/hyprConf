...
hl.bind("SUPER + R", hl.dsp.exec_cmd("notify-send 'resize submap' 'submap enabled' -u critical -r 100000001"))
hl.bind("SUPER + R", hl.dsp.submap("resize"))
hl.define_submap("resize", function()
	hl.bind("SUPER + M", hl.dsp.exec_cmd("notify-send 'move submap' 'submap enabled' -u critical -r 100000001"))
	hl.bind("SUPER + M", hl.dsp.submap("move"))
	hl.bind("SUPER + N", hl.dsp.exec_cmd("notify-send 'group submap' 'submap enabled' -u critical -r 100000001"))
	...
	hl.bind("SUPER + R", hl.dsp.exec_cmd("notify-send 'resize submap' 'submap disabled' -u normal -t 500 -r 100000001"))
	hl.bind("SUPER + R", hl.dsp.submap("reset"))
	hl.bind("Escape", hl.dsp.exec_cmd("notify-send 'resize submap' 'submap disabled' -u normal -t 500 -r 100000001"))
...
hl.define_submap("move", function()
	hl.bind("SUPER + R", hl.dsp.exec_cmd("notify-send 'resizewindow submap' 'submap enabled' -u critical -r 100000001"))
	hl.bind("SUPER + R", hl.dsp.submap("resize"))
	hl.bind("SUPER + N", hl.dsp.exec_cmd("notify-send 'group submap' 'submap enabled' -u critical -r 100000001"))
	hl.bind("SUPER + N", hl.dsp.submap("group"))
	...
	hl.bind("SUPER + k", hl.dsp.window.swap({ direction = "u" }))
	hl.bind("SUPER + j", hl.dsp.window.swap({ direction = "d" }))
	hl.bind("SUPER + h", hl.dsp.window.swap({ direction = "l" }))
	hl.bind("SUPER + l", hl.dsp.window.swap({ direction = "r" }))
	hl.bind("SUPER + M", hl.dsp.exec_cmd("notify-send 'move submap' 'submap disabled' -u normal -t 500 -r 100000001"))
	hl.bind("SUPER + M", hl.dsp.submap("reset"))
	hl.bind("Escape", hl.dsp.exec_cmd("notify-send 'move submap' 'submap disabled' -u normal -t 500 -r 100000001"))
	hl.bind("Escape", hl.dsp.submap("reset"))
end)
...
hl.define_submap("group", function()
	...
	hl.bind("SUPER + M", hl.dsp.exec_cmd("notify-send 'move submap' 'submap enabled' -u critical -r 100000001"))
	hl.bind("SUPER + M", hl.dsp.submap("move"))
	hl.bind("SUPER + k", hl.dsp.window.move({ out_of_group = "u" }))
	hl.bind("SUPER + j", hl.dsp.window.move({ out_of_group = "d" }))
	hl.bind("SUPER + h", hl.dsp.window.move({ out_of_group = "l" }))
	hl.bind("SUPER + l", hl.dsp.window.move({ out_of_group = "r" }))
	hl.bind("SUPER + k", hl.dsp.window.move({ into_group = "u" }))
	hl.bind("SUPER + j", hl.dsp.window.move({ into_group = "d" }))
	hl.bind("SUPER + h", hl.dsp.window.move({ into_group = "l" }))
	hl.bind("SUPER + l", hl.dsp.window.move({ into_group = "r" }))
	...
	hl.bind("y", hl.dsp.group.lock_active())
	hl.bind("SUPER + T", hl.dsp.group.next())
	hl.bind("SUPER + SHIFT + T", hl.dsp.group.prev())
	hl.bind("SUPER + N", hl.dsp.exec_cmd("notify-send 'group submap' 'submap disabled' -u normal -t 500 -r 100000001"))
	hl.bind("SUPER + N", hl.dsp.submap("reset"))
	hl.bind("Escape", hl.dsp.exec_cmd("notify-send 'group submap' 'submap disabled' -u normal -t 500 -r 100000001"))
	hl.bind("Escape", hl.dsp.submap("reset"))
end)
